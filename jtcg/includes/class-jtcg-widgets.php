...
class JTCG_Widget extends WP_Widget {
    
    public function __construct() {
        
        $widget_options = [
            'classname'     => 'jtcg-widget',
        ...
        parent::__construct( 'jtcg-widget', __('Mi Widget Personalizado', 'miprimerplugin'), $widget_options, $control_options  );
