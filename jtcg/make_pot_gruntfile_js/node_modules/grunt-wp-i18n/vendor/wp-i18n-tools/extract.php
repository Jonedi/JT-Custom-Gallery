...
class StringExtractor {
	...
	public function extraplugin_from_directory( $dir, $excludes = array(), $includes = array(), $prefix = '' ) {
		$old_cwd = getcwd();
		chdir( $dir );
		...
		foreach ( $file_names as $file_name ) {
			...
			if ( preg_match( '/\.php$/', $file_name ) && $this->does_file_name_match( $prefix . $file_name, $excludes, $includes ) ) {
				$extracted = $this->extraplugin_from_file( $file_name, $prefix );
				$translations->merge_originals_with( $extracted );
			}
			if ( is_dir( $file_name ) ) {
				$extracted = $this->extraplugin_from_directory( $file_name, $excludes, $includes, $prefix . $file_name . '/' );
				$translations->merge_originals_with( $extracted );
			}
		}
		chdir( $old_cwd );
	...
	public function extraplugin_from_file( $file_name, $prefix ) {
		$code = file_get_contents( $file_name );
		return $this->extraplugin_from_code( $code, $prefix . $file_name );
	}
	...
	public function extraplugin_from_code( $code, $file_name ) {
		$translations = new Translations;
