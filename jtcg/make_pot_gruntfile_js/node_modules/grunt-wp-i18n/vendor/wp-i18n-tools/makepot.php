...
class MakePOT {
	...
	public function xgettext( $project, $dir, $output_file, $placeholders = array(), $excludes = array(), $includes = array() ) {
		...
		$originals = $this->extractor->extraplugin_from_directory( $dir, $excludes, $includes );
		$pot = new PO;
	...
	public function wp_generic( $dir, $args ) {
		$defaults = array(
			...
			'extraplugin_not_gettexted'      => false,
	...
	public function wp_core( $dir, $output ) {
		...
		return $this->wp_generic(
			...
			array(
				'project'                    => 'wp-core',
				'output'                     => $output,
				'extraplugin_not_gettexted'      => true,
	...
	public function wp_theme( $dir, $output, $slug = null ) {
		...
		$extraplugin_templates = ! in_array( $slug, array( 'twentyten', 'twentyeleven', 'default', 'classic' ) );
		if ( ! $extraplugin_templates ) {
			$wp_dir = dirname( dirname( dirname( $dir ) ) );
			$extraplugin_templates = file_exists( "$wp_dir/wp-admin/user/about.php" ) || ! file_exists( "$wp_dir/wp-load.php" );
		}
		if ( $extraplugin_templates ) {
